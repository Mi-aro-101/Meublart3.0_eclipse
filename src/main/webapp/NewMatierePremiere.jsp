...
<div class="col-lg-6 quote-text py-5 wow fadeIn myform"
	...
	<div class="text-start">
		<center>
			<h1>Inserer une matiere premiere</h1>
		</center>
	</div>
	<div class="p-lg-5 pe-lg-0">
		<form action="nouveaumatiere.do" method="post">
			<div class="row g-3">
				<div class="col-12">
				...
				<div class="col-12">
					<input type="text" class="form-control border-0" placeholder="prix"
						name="prixUnitaire" style="height: 55px;">
				</div>
				<div class="col-12">
