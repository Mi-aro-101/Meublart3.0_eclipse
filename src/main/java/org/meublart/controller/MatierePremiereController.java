...
public class MatierePremiereController {
    ...
    public ModelView insererMatierePremiere(String designation, double prixUnitaire)throws Exception{
        MatierePremiere matiere = new MatierePremiere(null, designation, prixUnitaire);
