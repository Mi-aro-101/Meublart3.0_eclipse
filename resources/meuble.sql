...
select o.*, p.salaire
    from ouvrier o join poste p on o.id_poste = p.id_poste

create or replace view v_ouvrier_poste_grade as
    SELECT o.id_ouvrier, (current_date - date_embauche)/365 anciennete, p.salaire*pr.valeur as salaire, pr.designation
    FROM ouvrier o
    JOIN poste p on o.id_poste = p.id_poste
